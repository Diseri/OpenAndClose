    ...
    // chromeStorage.get("UrltoNavigateTo", function(obj) {
        // if (obj) {
            // if (obj.UrltoNavigateTo) {
                // var txtUrltoNavigateTo = document.getElementById('txtUrltoNavigateTo');
                // if (txtUrltoNavigateTo)
                    // txtUrltoNavigateTo.value = obj.UrltoNavigateTo;
            // }
        // }
    // });
	}
...
$(document).ready(function() {		
    ...
    // }).change(function() {
		...
		// var weekday = ["Sun","Mo","Tue","Wed","Thu","Fri","Sat"];
		// var wrapper = $("#addtoRow");
		// var wrapper3 = $("#addtoRow")[0]; //Fields wrapper
		
		
		// var found = false;
		// var tds = $(wrapper3).find("td"); 
		// $(tds).each(function(e) { 
			// var text = $($($(tds)[e]).children()[0]).text();
		
			// if(text ==weekday[date.getDay()])
			// {
				// found = true;
			// }
		// });
		...
		// if(!found)
		// {
			// $(wrapper).append('<td class="btn btn-info"><span>'+weekday[date.getDay()]+'</span><a href="#" class="remove_field" style="color:black;">  <img style="width:10px;" src="images/x.png" class="img-rounded"></a></td>'); //add input box
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    checkPageButton.addEventListener('click', function() {
        ...
        // if (!txtUrltoNavigateTo || !txtUrl) {
            // alert('Error: Invalid Control!!!!!');
            // return;
        // }
        ...
        // if (txtUrltoNavigateTo.value == '' || txtUrl.value == '') {
            // return;
        // }
        ...
        // }, function() {});
        // chromeStorage.set({
            // 'UrltoNavigateTo': txtUrltoNavigateTo.value
        // }, function() {
            // setSaveBtnEnable(false);
        // });
    ...
    if (request) {
        if (request.message) {
            if (request.message == 'Running') {
                $('#spnStatus').text("Running");
                //$('#spnStatus').attr("title", "Click on this extensions icon to switch it off.");
                $('#spnStatus').css('color', 'green');
            } else {
                $('#spnStatus').text("Stopped");
                //$('#spnStatus').attr("title", "Click on this extensions icon to switch it on.");
                $('#spnStatus').css('color', 'red');
            }
        }
